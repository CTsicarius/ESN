...
u_train = create_sinusoidal(5, 10000, 0)
#y_train = (1/2)*(u_train^7)
y_train = (1/2)*(create_sinusoidal(5, 10000, 0))^7
u_test = create_sinusoidal(5, 10000, 0)
#y_test = (1/2)*(u_test^7)
y_test = (1/2)*(create_sinusoidal(5, 10000, 0))^7
